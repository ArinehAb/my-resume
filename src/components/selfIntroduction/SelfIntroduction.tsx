...
const SelfIntroduction: React.FC = () => {
  return (
    <div className="w-full min-h-[40vh] bg-gradient-to-br from-[#FFF8F0] to-[#F5E1DC] font-sans flex items-center border-b border-[#EBDDCB]">
      <div className="container mx-auto max-w-7xl px-8 flex items-center">
        {/* Profile Picture */}
        <div className="flex-shrink-0">
          <img
            src="/me.jpeg"
            alt="Profile"
            className="w-64 h-64 rounded-full border-4 border-[#D4A59A] shadow-2xl object-cover"
          />
        </div>
        ...
        <div className="ml-16">
          ...
          <h2 className="mt-6 text-3xl text-[#7B4B3A]">
            Software Engineer
          </h2>
